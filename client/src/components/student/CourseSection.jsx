...
console.log("allCourses",allCourses)
  ...
  return (
    <div className='py-16 md:px-40 px-8'>
        ...
        <p className='text-sm md:text-base text-gray-500 mt-3'>Discover our top-rated courses across various categories. From coding and design to <br/> business to business and wellness, our courses are crafted to deliver results.</p>
