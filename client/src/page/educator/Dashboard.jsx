...
const Dashboard =()=>{
   ...
   useEffect(()=>{
    ...
    return dashboardData ?(
        <div className=" flex flex-col items-start justify-between gap-8 md:p-8 md:pb-0 p-4 pt-8 pb-0">
         <div className="space-y-5">
          <div className="flex flex-wrap gap-5 items-center">
            <div className="flex items-center gap-3 shadow-card border border-blue-500 p-4 w-56 rounded-md">
             <img src={assets.patients_icon} alt="patient_icon"/>
             <div>
               <p className="text-2xl fornt-medium text-gray-600">
         ...
         <table className="table-fixed md:table-auto w-full overflow-hidden">
           ...
           {dashboardData.enrolledStudentsData.map((item,index)=>(
            <tr key={index} className="border-b border-gray-500/20">
              ...
              <td className="px-4 py-3 trucate">{item.courseTitle}</td>
            </tr>
           ))}
           </tbody>
         </table>
